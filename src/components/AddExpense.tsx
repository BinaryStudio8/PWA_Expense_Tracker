    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <Listbox value={category} onChange={setCategory}>
                            <Listbox.Button
                                className="flex items-center w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm pl-10 pr-10 py-3 text-sm sm:text-base text-gray-800 dark:text-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 hover:border-blue-400"
                            >
                            ...
                            >
                                <Listbox.Options
                                    className="absolute z-50 mt-1 w-full max-h-60 overflow-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl focus:outline-none"
                                >
                                    {categories.map((cat) => (
                                        <Listbox.Option
                                            key={cat}
                                            ...
                                            className={({ active, selected }) =>
                                                `cursor-pointer select-none px-4 py-3 text-sm sm:text-base transition-colors duration-150 ${active
                ...
                <TextAreaField
                    icon={<StickyNote className="h-5 w-5 text-gray-400 dark:text-gray-500" />}
                ...
                <button
                    ...
                    className={`w-full py-4 rounded-xl font-semibold text-white flex items-center justify-center gap-3 shadow-lg transition-all duration-300 ${title && amount
