                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">{c.subtitle}</p>
                            </div>
                            <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{c.value}</div>
                        </div>
                    </div>
                ))}
            </div>
        ) : (
            <p className="text-sm text-gray-600 dark:text-gray-400">No insights yet — add more expenses.</p>
        )}
    </div>
));
