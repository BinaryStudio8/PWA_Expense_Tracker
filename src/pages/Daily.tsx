import { CalendarDays, IndianRupee, Clock, ChevronDown, MapPin, FileText, Sparkles } from "lucide-react";
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div className="text-left sm:text-right">
                                ...
                                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">
                                    Top: <span className="font-medium">{mostExpensive.title}</span> (₹{formatIndianNumber(mostExpensive.amount)})
                                </p>
                            </div>
                        </div>
                                            ...
                                            >
                                                ...
                                                {expense.description && (
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <p className="leading-relaxed text-base">{expense.description}</p>
                                                    </div>
                                                )}
